...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>
            <span class="ancestors"><a href="module-Pending.html">Pending</a><a href="module-node_modules_mocha_mocha.html">~node_modules/mocha/mocha</a>~</span>Runner<span class="signature">(suite, opts<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h2>
...
<article>
    ...
    <h4 class="name" id="Runner"><span class="type-signature"></span>new Runner<span class="signature">(suite, opts<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h4>
...
<div class="description">
    Initialize a `Runner` at the Root <a href="Suite.html">Suite</a>, which represents a hierarchy of <a href="Suite.html">Suites</a> and <a href="Test.html">Tests</a>.
</div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>suite</code></td>
            

            <td class="type">
            
                
<span class="param-type"><a href="Suite.html">Suite</a></span>
            ...
            <td class="description last">Root suite</td>
        </tr>
...
<span class="param-type">Object</span>
            ...
            <td class="description last">Settings object
                <h6>Properties</h6>
...
<span class="param-type">boolean</span>
            ...
            <td class="description last">Whether to clean references to test fns and hooks when a suite is done.</td>
        </tr>
...
<span class="param-type">boolean</span>
            ...
            <td class="description last">Whether to delay execution of root suite until ready.</td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>dryRun</code></td>
...
<span class="param-type">boolean</span>
            ...
            <td class="description last">Whether to report tests without running them.</td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>failZero</code></td>
...
<span class="param-type">boolean</span>
            ...
            <td class="description last">Whether to fail test run if zero tests encountered.</td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="node_modules_mocha_mocha.js.html">node_modules/mocha/mocha.js</a>, <a href="node_modules_mocha_mocha.js.html#line14134">line 14134</a>
    </li></ul></dd>
    ...
    <ul>
        <li><a href="external-EventEmitter.html">external:EventEmitter</a></li>
    </ul>
...
<h4 class="name" id="_eventListeners"><span class="type-signature"></span>_eventListeners<span class="type-signature"> :Map:<a href="global.html"></a>.&lt;EventEmitter:<a href="global.html"></a>, Map:<a href="global.html"></a>.&lt;string:<a href="global.html"></a>, Set:<a href="global.html"></a>.&lt;EventListener:<a href="global.html"></a>>>></span></h4>
...
<span class="param-type">Map:<a href="global.html"></a>.&lt;EventEmitter:<a href="global.html"></a>, Map:<a href="global.html"></a>.&lt;string:<a href="global.html"></a>, Set:<a href="global.html"></a>.&lt;EventListener:<a href="global.html"></a>>>></span>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="node_modules_mocha_mocha.js.html">node_modules/mocha/mocha.js</a>, <a href="node_modules_mocha_mocha.js.html#line14148">line 14148</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="node_modules_mocha_mocha.js.html">node_modules/mocha/mocha.js</a>, <a href="node_modules_mocha_mocha.js.html#line14267">line 14267</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="isParallelMode"><span class="type-signature"></span>isParallelMode<span class="signature">()</span><span class="type-signature"> &rarr; {false}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="node_modules_mocha_mocha.js.html">node_modules/mocha/mocha.js</a>, <a href="node_modules_mocha_mocha.js.html#line15160">line 15160</a>
    </li></ul></dd>
...
<span class="param-type">false</span>
    ...
    <h4 class="name" id="linkPartialObjects"><span class="type-signature">(abstract) </span>linkPartialObjects<span class="signature">(value<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {<a href="Runner.html">Runner</a>}</span></h4>
...
<span class="param-type">boolean</span>
            ...
            <td class="description last">If `true`, enable partial object linking, otherwise disable</td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="node_modules_mocha_mocha.js.html">node_modules/mocha/mocha.js</a>, <a href="node_modules_mocha_mocha.js.html#line15121">line 15121</a>
    </li></ul></dd>
...
<span class="param-type"><a href="Runner.html">Runner</a></span>
    ...
    <pre class="prettyprint"><code>// this reporter needs proper object references when run in parallel mode
class MyReporter() {
  constructor(runner) {
    ...
    <h4 class="name" id="workerReporter"><span class="type-signature">(abstract) </span>workerReporter<span class="signature">(path)</span><span class="type-signature"> &rarr; {<a href="Runner.html">Runner</a>}</span></h4>
...
<span class="param-type">string</span>
            ...
            <td class="description last">Absolute path to alternate reporter for worker processes to use</td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="node_modules_mocha_mocha.js.html">node_modules/mocha/mocha.js</a>, <a href="node_modules_mocha_mocha.js.html#line15174">line 15174</a>
    </li></ul></dd>
