...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: node_modules/workerpool/src/index.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: node_modules/workerpool/src/index.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>var environment = require('./environment');
...
exports.cpus = environment.cpus;</code></pre>
        </article>
    </section>
