...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Module: node_modules/mocha/mocha</title>
...
<div id="main">
    ...
    <h1 class="page-title">Module: node_modules/mocha/mocha</h1>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="node_modules_mocha_mocha.js.html">node_modules/mocha/mocha.js</a>, <a href="node_modules_mocha_mocha.js.html#line12209">line 12209</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="module:node_modules/mocha/mocha"><span class="type-signature"></span>module:node_modules/mocha/mocha<span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="node_modules_mocha_mocha.js.html">node_modules/mocha/mocha.js</a>, <a href="node_modules_mocha_mocha.js.html#line13352">line 13352</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="node_modules_mocha_mocha.js.html">node_modules/mocha/mocha.js</a>, <a href="node_modules_mocha_mocha.js.html#line18258">line 18258</a>
    </li></ul></dd>
        ...
        <dl>
            <dt><a href="module-node_modules_mocha_mocha-Runner.html">Runner</a></dt>
            <dd></dd>
        </dl>
...
<h4 class="name" id="~StatsCollector">StatsCollector</h4>
...
<table class="props">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>suites</code></td>
...
<span class="param-type">number</span>
            ...
            <td class="description last">integer count of suites run.</td>
        </tr>
...
<span class="param-type">number</span>
            ...
            <td class="description last">integer count of tests run.</td>
        </tr>
...
<span class="param-type">number</span>
            ...
            <td class="description last">integer count of passing tests.</td>
        </tr>
...
<span class="param-type">number</span>
            ...
            <td class="description last">integer count of pending tests.</td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>failures</code></td>
...
<span class="param-type">number</span>
            ...
            <td class="description last">integer count of failed tests.</td>
        </tr>
...
<span class="param-type"><a href="global.html#Date">Date</a></span>
            ...
            <td class="description last">time when testing began.</td>
        </tr>
...
<span class="param-type"><a href="global.html#Date">Date</a></span>
            ...
            <td class="description last">time when testing concluded.</td>
        </tr>
...
<span class="param-type">number</span>
            ...
            <td class="description last">number of msecs that testing took.</td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="node_modules_mocha_mocha.js.html">node_modules/mocha/mocha.js</a>, <a href="node_modules_mocha_mocha.js.html#line18272">line 18272</a>
    </li></ul></dd>
...
<article>
    <div class="container-overview">
            ...
            <div class="description">Provides a factory function for a StatsCollector object.</div>
